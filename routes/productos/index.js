...
router.post("/",      /* verifyJWT, checkPermiso("productos:create"), */ upload("productos", "imagen"), handleUploadError, ctrl.createProductoCtrl);
router.put("/:id",    /* verifyJWT, checkPermiso("productos:update"), */ upload("productos", "imagen"), handleUploadError, ctrl.updateProductoCtrl);
